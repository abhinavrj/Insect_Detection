    ...
    private void updateUI(FirebaseUser fuser){
        ...
        if (account!=null){
            ...
            b.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent emailIntent=new Intent(Intent.ACTION_SENDTO,Uri.fromParts("mailto",personEmail,"Insect"));
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Insect and its Geolocation");
                    emailIntent.putExtra(Intent.EXTRA_TEXT,"Insect");
